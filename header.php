...
<body>
                ...
                <div class="navbar-part me-auto">
                    <div class="navbar-content">
                        <ul id="primary-menu" class="navbar-list">
                            ...
                            <li class="navbar-item dropdown"><a href="#" class="navbar-link dropdown-arrow">Blockchain Services</a>
                                <ul class="dropdown-position-list">
                                    <li><a href="blockchain-development.php">Blockchain Development</a></li>
                                    <li><a href="crypto-exchange-development.php">Crypto Exchange Development</a></li>
                                    <li><a href="cryptocurrency-development.php">Cryptocurrency Development</a></li>
                                    <li><a href="defi-wallet.php">Defi Wallet Development</a></li>
                                    <li><a href="ico-development.php">ICO Development</a></li>
                                    <li><a href="ido-development.php">IDO Development</a></li>
                                    <li><a href="launchpad-development.php">Launchpad Development</a></li>
                                    <li><a href="nft-marketplace.php">NFT Marketplace Development</a></li>
                                    <li><a href="smart-contract.php">Smart Contract Development</a></li>
                                </ul>
                            </li>
                            <li class="navbar-item"><a href="https://telegramminiappdevelopement.com" target="_blank" class="navbar-link">Telegram Mini App</a></li>
                ...
                <div class="header-widget-group">
                    <div class="top-call">
                        ...
                        <div>
                            ...
                            <p class="mb-0"><a href="https://api.whatsapp.com/send?phone=918949680700">+91 8949 680 700</a></p>
                        </div>
                    </div>
                    <a class="header-widget btn btn-default" href="contact-us.php" target="_self">Get in Touch</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <aside class="nav-sidebar">
        ...
        <div class="nav-content pt-2">
            <ul id="mobile-menu" class="nav-list">
                ...
                <li class="nav-item"><a href="https://telegramminiappdevelopement.com" target="_blank" class="nav-link">Telegram Mini App</a></li>
    ...
    <ul class="fixedicon">
        <li><a href="https://www.linkedin.com/company/codebird-technologies-pvt-ltd" target="_blank"><img src="images/linkedin.png" alt="linkedin"></a></li>
        <li><a href="https://api.whatsapp.com/send?phone=918949680700" target="_blank"><img src="images/whatsapp.png" alt="whatsapp"></a></li>
        <li><a href="https://t.me/govind_codebird" target="_blank"><img src="images/telegram.png" alt="telegram"></a></li>
        <li><a href="https://www.instagram.com/codebird_tech/?utm_medium=copy_link" target="_blank"><img src="images/instagram.png" alt="instagram"></a></li>
    </ul>
